...
"-----------------------------------------------------------------
let g:DoxygenToolkit_authorName="xm2 - "
let g:DoxygenToolkit_briefTag_funcName="yes"
map <leader>da :DoxAuthor<CR>
map <leader>df :Dox<CR>
map <leader>db :DoxBlock<CR>
map <leader>dc a /* */<LEFT><LEFT><LEFT>
let g:load_doxygen_syntax=1  "doxygen highlight

"-----------------------------------------------------------------
" plugin - YCM work with UltiSnips
"-----------------------------------------------------------------
...
" plugin – django.vim
"-----------------------
let g:django_projects = '~/Workspace/Projects' "Sets all projects under project
...
"-----------------------
" Autocmd to update ctags file && Automatically create and update cscope
" database
"-----------------------
...
"-----------------------------------------------------------------
"" nmap <F11> automatically create and update cscope database 
"-----------------------------------------------------------------
nmap <F11> :!find . -iname '*.c' -o -iname '*.cpp' -o -iname '*.h' -o -iname '*.hpp' > cscope.files<CR>
            \:!cscope -bqk -i cscope.files -f cscope.out<CR>
            \:cs reset<CR>
